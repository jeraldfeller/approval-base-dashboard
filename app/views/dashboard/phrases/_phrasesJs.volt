...
<script type="text/javascript">
  $(function () {
    ...
    if ($hasToured != 'true') {
      if ($tourFinal != null) {
        ...
        if ($hasToured == null) {
          ...
          tour.addStep('step', {
            title: 'Search phrase',
            text: 'Enter a search phrase, choose phrase-specific filters and click Create Phrase',
            attachTo: {
              element: '.step-phrase',
              on: 'left'
            },
          ...
          tour.addStep('step', {
            text: 'Your phrase will be added here',
            attachTo: {
              element: '.step-table',
              on: 'top'
            },
    ...
    var table = $("#dt-opt").DataTable({
      ...
      "filter": false,
      "columnDefs": [
        {"targets": [0, 1, 2, 3,], "className": "text-center vertical-middle"},
    ...
    $('#createBtn').click(function () {
      ...
      $data = {
        ...
        'inputLiteralSearch': ($('#input_literal_search').is(':checked') == true ? 1 : 0),
    ...
    $('.editSave').click(function () {
      ...
      $data = {
        ...
        'inputLiteralSearch': ($('#input_literal_search_edit').is(':checked') == true ? 1 : 0),
      ...
      $.ajax({
        ...
        $.ajax({
          ...
          if(response == true){
            showNotification('Phrase successfully updated.', 'success');
          }else{
